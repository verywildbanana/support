...
public class PkSlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_PADDING_DIPS = 17;
    ...
    public PkSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PkSlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new PkSlidingTabStrip(context);
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link PkSlidingTabLayout} you are
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (viewPager != null) {
            ...
            mInternalViewPagerListener = new InternalViewPagerListener();
            
            mTextViewArray = new ArrayList<PkTextView>();
            populateTabStrip();
        }
    }
...
//        }
    ...
    public void setTabClickListener(OnClickListener listener) {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            View tabView = null;
            PkTextView tabTitleView = null;

            if (mTabViewLayoutId != 0) {
                // If there is a custom tab view layout id set, try and inflate it
                tabView = LayoutInflater.from(getContext()).inflate(mTabViewLayoutId, mTabStrip,
                        false);
                tabTitleView = (PkTextView) tabView.findViewById(mTabViewTextViewId);
            }
            ...
            if (tabTitleView == null && PkTextView.class.isInstance(tabView)) {
                tabTitleView = (PkTextView) tabView;
            }
